...
export declare type SectionComponent = IButtonComponent | ILabelComponent | ILineComponent | ILinkComponent | ITitleComponent | ICustomerComponent | ITagsComponent;
export declare enum SectionComponentType {
    Button = "button",
