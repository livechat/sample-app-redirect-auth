...
import { subMonths, addMonths, differenceInCalendarMonths, isSameMonth, isAfter, isSameDay, format, differenceInCalendarDays } from 'date-fns';
import { createPortal } from 'react-dom';
import ResizeObserver from 'resize-observer-polyfill';
import memoizeOne from 'memoize-one';
import { Manager, Reference, Popper } from 'react-popper';
import { throttle, generateUniqueId } from '@livechat/data-utils';
...
import { createElement, Children, cloneElement, Component, createRef, forwardRef, createContext, Fragment, PureComponent } from 'react';
import { node, string, oneOfType, element, bool, func, number, arrayOf, oneOf, shape, object, instanceOf, any, objectOf } from 'prop-types';
...
process.env.NODE_ENV !== "production" ? Button.propTypes = {
   ...
   * Size of button
   */
  size: oneOf(['compact', 'large']),
  submit: bool,
  type: string,
  /**
   * Type of button
   */
  kind: oneOf(['primary', 'secondary', 'destructive', 'text']),
  /**
...
var ButtonGroup = function (_React$Component) {
  ...
  ButtonGroup.prototype.render = function render() {
    ...
    var mappedChildren = Children.map(children, function (child, i) {
      var _cx;
...
var BannerIcon = function BannerIcon(props) {
    ...
    switch (type) {
        case 'info':
            return createElement(InformationOutlineIcon, { fill: '#4384f5', width: '20px', height: '20px', className: styles$3[baseClass$4] });
        case 'warning':
            return createElement(AlertIcon, { fill: '#fb9d01', width: '20px', height: '20px', className: styles$3[baseClass$4] });
        case 'success':
            return createElement(CheckCircleIcon, { fill: '#38c776', width: '20px', height: '20px', className: styles$3[baseClass$4] });
        case 'error':
            return createElement(BlockHelperIcon, { fill: '#d64646', width: '20px', height: '20px', className: styles$3[baseClass$4] });
    }
};

process.env.NODE_ENV !== "production" ? BannerIcon.propTypes = {
    type: oneOf(['info', 'warning', 'success', 'error']).isRequired
} : void 0;
...
var Banner = function Banner(props) {
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(BannerIcon, { type: type }),
      createElement(
        'div',
    ...
    onClose && createElement(
      ...
      createElement(CloseIcon, { fill: '#424d57' })
    )
  );
};
...
var Card = function Card(props) {
  ...
  return createElement(
    'div',
    _extends({}, restProps, { className: mergedClassNames }),
    (img || title) && createElement(
      'div',
      { className: styles$4[baseClass$6 + '__title'] },
      img && createElement('img', { src: img, className: styles$4[baseClass$6 + '__img'] }),
      title && createElement(
        'div',
...
var Tab = function Tab(_ref) {
  ...
  var Component$$1 = function Component$$1(props) {
    return href ? createElement('a', props) : createElement('button', props);
  };
  ...
  return createElement(
    ...
    children,
    isDescriptionProvided && createElement(
      'span',
...
process.env.NODE_ENV !== "production" ? Tab.propTypes = {
  children: node.isRequired,
  className: string,
  description: oneOfType([string, number, node]),
  href: string,
  isSelected: bool
} : void 0;
...
process.env.NODE_ENV !== "production" ? TooltipContent.propTypes = {
  ...
  fontColor: string,
  children: node.isRequired,
  arrowPosition: oneOf([ARROW_POSITION.Left, ARROW_POSITION.Right, ARROW_POSITION.Top, ARROW_POSITION.Bottom]),
  arrowAlign: oneOf([ALIGMENT.Top, ALIGMENT.Bottom, ALIGMENT.Left, ALIGMENT.Right, ALIGMENT.Center]),
  arrowOffset: number
} : void 0;
...
process.env.NODE_ENV !== "production" ? TooltipBox.propTypes = {
  ...
  xPosition: number.isRequired,
  yPosition: number.isRequired,
  onContentMouseEnter: func,
  onContentMouseLeave: func,
  contentRef: oneOfType([object, func, string]).isRequired
} : void 0;
...
process.env.NODE_ENV !== "production" ? Tooltip.propTypes = {
  ...
  className: string,
  keepContentVisibleOnHover: bool,
  isTooltipVisible: bool,
  offset: number,
  trigger: oneOf(['hover', 'click', 'custom']),
  align: oneOf(['top', 'center', 'bottom', 'left', 'right']),
  inline: bool,
...
var ToastIcon = function ToastIcon(_ref) {
  ...
  switch (variant) {
    case SUCCESS:
      return createElement(CheckCircleIcon, null);
    case WARNING:
      return createElement(AlertIcon, null);
    case ERROR:
      return createElement(AlertCircleIcon, null);
    default:
      return createElement(InformationIcon, null);
  }
};
...
var Toast = function Toast(props) {
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(ToastIcon, { variant: variant })
    ),
    createElement(
      'div',
    ...
    (action || removable) && createElement(
      'div',
      { className: styles$7.toast__actions },
      action && action.label && action.handler && createElement(
        'button',
        {
  ...
  ToastConsumer.prototype.render = function render() {
    ...
    return createElement(
      ...
      function (notificationSystem) {
        return createElement(ToastWrapper, _extends({}, restProps, {
          fixed: fixed,
...
process.env.NODE_ENV !== "production" ? ToastConsumer.propTypes = {
  ...
  fixed: bool,
  animationType: string,
  verticalPosition: string.isRequired,
  horizontalPosition: string.isRequired
} : void 0;
...
var notificationConnect = function notificationConnect(Component$$1) {
...
var ModalCloseButton = function ModalCloseButton(props) {
  return createElement(
    ...
    createElement(CloseIcon, { width: '24px', height: '24px', fill: '#424D57' })
  );
};
...
var ModalBase = function (_React$Component) {
  ...
  function ModalBase() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.onOverlayClick = function (event) {
      ...
      _this.props.onClose();
    }, _this.modalRef = createRef(), _temp), possibleConstructorReturn(_this, _ret);
  }
  ...
  ModalBase.prototype.render = function render() {
    ...
    return createElement(
      ...
      createElement(
        ...
        createElement(ModalCloseButton, { onClick: this.onCloseButtonClick }),
        children
      )
    );
  };
...
var FieldLabel = function FieldLabel(_ref) {
  ...
  return createElement('label', _extends({ className: mergedClassNames }, restProps));
};
...
var TextField = function TextField(props) {
  ...
  return createElement(
    "div",
    { className: mergedClassNames },
    labelRightNode && inline && createElement(
      Fragment,
      null,
      createElement(
        "div",
      ...
      createElement("div", { className: cx$d(baseClass + "__row-break") })
    ),
    createElement(
      "div",
      { className: cx$d([baseClass + "__wrapper", inline && baseClass + "__wrapper--inline"]) },
      (labelText || labelRightNode) && createElement(
        "div",
...
var Input = forwardRef(function (props, ref) {
  ...
  return createElement('input', _extends({ ref: ref, className: mergedClassNames, style: mergedStyle }, restProps));
});
...
var TextArea = forwardRef(function (props, ref) {
  ...
  return createElement('textarea', _extends({ ref: ref, className: mergedClassNames, style: mergedStyle }, restProps));
});
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(
        ...
        createElement('span', { className: styles$f[baseClass + '__inner-circle'] }),
...
var Checkbox = function Checkbox(props) {
  ...
  return createElement(
    ...
    createElement(
      'div',
      { className: mergedClassNames },
      createElement(CheckIcon, { className: styles$g[baseClass$i + '__checkmark'] })
    )
  );
};
...
var CheckboxField = function CheckboxField(props) {
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(Checkbox, _extends({}, restProps, { checked: checked, disabled: disabled })),
      createElement(
        'div',
...
var Form = function Form(_ref) {
  ...
  return createElement(
    ...
    (labelText || helperText) && createElement(
      'div',
...
process.env.NODE_ENV !== "production" ? SelectList.propTypes = {
  ...
  onListClose: func,
  selectedItem: oneOfType([string, number]),
  getItemSelectedHandler: func,
  onEnterKey: func,
  focusedItemKey: string,
  onFocusedItemChange: func,
  listRef: shape({
    current: instanceOf(typeof Element === 'undefined' ? function () {} : Element)
  }),
  selectHeader: string
} : void 0;
...
var SelectHead = forwardRef(function (props, ref) {
  var _cx;
...
process.env.NODE_ENV !== "production" ? SelectHeadItem.propTypes = {
  ...
  placeholder: string,
  getSelectedItemBody: func
} : void 0;

var baseClass$n = 'select-head';
var cx$m = classNames.bind(styles$k);

var ClearButton = forwardRef(function (props, ref) {
  var _cx;
...
var Select = function (_React$PureComponent) {
  ...
  function Select(props) {
    ...
    _this.headRef = createRef();
    _this.clearButtonRef = createRef();
  ...
  Select.prototype.render = function render() {
    ...
    return createElement(
      ...
      createElement(
        ...
        createElement(ClearButton, {
          isVisible: shouldRenderClearButton,
          ref: this.clearButtonRef,
          clearSelectedOption: this.clearSelectedOption
        }),
        createElement(MenuDownIcon, { width: '24px', height: '24px', fill: '#424d57', 'data-testid': 'select-down-icon' })
      ),
      createElement(
        'div',
        {
...
process.env.NODE_ENV !== "production" ? Select.propTypes = {
   ...
   */
  searchEmptyState: node,
  items: arrayOf(shape({
    key: string,
    props: object
  })),
  searchPlaceholder: string,
  searchProperty: oneOfType([string, arrayOf(string)]),
...
var SelectField = function SelectField(props) {
  ...
  return createElement(
    ...
    createElement(Select, _extends({}, restProps, { className: fieldClassName, id: id, error: error }))
  );
};
...
var MultiSelectList = function (_React$PureComponent) {
  ...
  MultiSelectList.prototype.render = function render() {
    ...
    return createElement(
      ...
      toggleAllOptions && createElement(
        SelectItem$1,
        {
...
process.env.NODE_ENV !== "production" ? MultiSelectList.propTypes = {
  ...
  onListClose: func,
  selectedItems: arrayOf(oneOfType([string, number])),
  getItemSelectedHandler: func,
  onEnterKey: func,
  focusedItemKey: string,
  onFocusedItemChange: func,
  ...
  toggleAllOptions: shape({
    onToggleAll: func.isRequired,
    selectLabel: string,
    clearLabel: string
  })
} : void 0;
...
var MultiSelectHead = forwardRef(function (props, ref) {
  var _cx;
...
var MultiSelect = function (_React$PureComponent) {
  ...
  function MultiSelect(props) {
    ...
    _this.headRef = createRef();
    _this.listRef = createRef();
    _this.selectedItemsContainerRef = createRef();
    return _this;
  }
      ...
      createElement(
        ...
        createElement(
          ...
          selectedItemsModels && selectedItemsModels.map(function (item) {
            return createElement(MultiSelectHeadItem, {
              key: item.key,
              getSelectedItemBody: getSelectedItemBody,
              item: item,
...
process.env.NODE_ENV !== "production" ? MultiSelect.propTypes = {
  ...
  error: string,
  getItemBody: func.isRequired,
  getSelectedItemBody: func.isRequired,
  onItemSelect: func.isRequired,
  ...
  placeholder: string,
  searchProperty: oneOfType([string, arrayOf(string)]),
  selected: arrayOf(oneOfType([string, number])),
  search: bool,
  /**
  ...
  maxItemsContainerHeight: number.isRequired,
  onDropdownToggle: func
} : void 0;
...
var MultiSelectField = function MultiSelectField(props) {
  ...
  return createElement(
    ...
    createElement(MultiSelect, _extends({}, restProps, {
      className: fieldClassName,
      id: id,
      error: error
    }))
...
var NumericInputField = function NumericInputField(props) {
  ...
  return createElement(
    ...
    createElement(NumericInput, _extends({}, restProps, {
      className: fieldClassName,
      id: id,
      error: error
    }))
...
var DatePickerNavbar = function DatePickerNavbar(props) {
  ...
  var handlePrevYearClick = function handlePrevYearClick() {
    if (!fromMonth) {
      var _newMonth = subMonths(month, 12);
      return onMonthChange(_newMonth);
    }
    var diff = Math.abs(differenceInCalendarMonths(month, fromMonth));
    var newMonth = subMonths(month, !Number.isNaN(diff) && diff > 12 ? 12 : diff);
    return onMonthChange(newMonth);
  };

  var handleNextYearClick = function handleNextYearClick() {
    if (!toMonth) {
      var _newMonth2 = addMonths(month, 12);
      return onMonthChange(_newMonth2);
    }
    var diff = Math.abs(differenceInCalendarMonths(toMonth, month));
    var newMonth = addMonths(month, !Number.isNaN(diff) && diff > 12 ? 12 : diff);
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement(
        ...
        createElement(ChevronDoubleLeftIcon, { width: '20px', height: '20px', fill: '#4384f5' })
      ),
      createElement(
        'button',
        {
        ...
        createElement(ChevronLeftIcon, { width: '20px', height: '20px', fill: '#4384f5' })
      )
    ),
    createElement(
      'div',
      ...
      createElement(
        ...
        createElement(ChevronRightIcon, { width: '20px', height: '20px', fill: '#4384f5' })
      ),
      createElement(
        'button',
        {
        ...
        createElement(ChevronDoubleRightIcon, { width: '20px', height: '20px', fill: '#4384f5' })
      )
    )
  );
};
...
var DatePicker = function (_React$PureComponent) {
  ...
  DatePicker.prototype.render = function render() {
    ...
    return createElement(ReactDayPicker, _extends({
      navbarElement: navbarElement || createElement(DatePickerNavbar, {
...
var DatePicker$1 = forwardRef(function (props, ref) {
  return createElement(DatePicker, _extends({ innerRef: ref }, props));
});
...
var DatePickerRangeSelectInputs = function DatePickerRangeSelectInputs(props) {
  ...
  return createElement(
    'div',
    restProps,
    createElement(Input, _extends({}, from, {
    ...
    createElement(Input, _extends({}, to, {
...
var RangeDatePicker = function (_React$Component) {
  ...
  function RangeDatePicker(props) {
    ...
    _this.initialState = {
      ...
      error: null,
      enteredTo: undefined,
      currentMonth: props.initialToDate ? _this.calculateDatepickerMonth(props.initialToDate, props.initialFromDate && !isSameMonth(props.initialFromDate, props.initialToDate)) : subMonths(props.toMonth, 1)
    };
...
var _initialiseProps$2 = function _initialiseProps() {
  ...
  this.getModifiers = memoizeOne(function (from, enteredTo) {
    ...
    if (enteredTo) {
      ...
      var diff = differenceInCalendarDays(enteredTo, from);
      if (diff > 0) {
        var _babelHelpers$extends;
  ...
  this.getRangeDatePickerApi = function () {
    ...
    return {
      ...
      datepicker: {
        ...
        modifiers: modifiers,
        initialMonth: _this2.state.from || subMonths(_this2.props.toMonth, 1),
  ...
  this.handleDayClick = function (day) {
    ...
    } else if (isSameDay(day, _this2.state.from) || isAfter(day, _this2.state.from)) {
  ...
  this.handleDateFromChange = function (e) {
    ...
    if (!isDateWithinRange(new Date(value), { to: _this2.props.toMonth })) {
      return _this2.setState(_extends({}, newState, {
        error: 'The date can\'t be later than ' + format(_this2.props.toMonth, 'YYYY-MM-DD')
      }));
    }
  ...
  this.handleDateToChange = function (e) {
    ...
    if (_this2.state.from === undefined) {
      return _this2.setState(_extends({}, newState, {
        ...
        currentMonth: _this2.calculateDatepickerMonth(new Date(value), !isSameMonth(new Date(value), _this2.state.from))
      }));
    }
  ...
  this.handleDayMouseEnter = function (day) {
    ...
    var isInRange = _this2.props.toMonth ? differenceInCalendarDays(_this2.props.toMonth, day) >= 0 : true;
  ...
  this.calculateDatepickerMonth = function (date) {
    ...
    if (forcePreviousMonth || _this2.props.toMonth && isSameMonth(date, _this2.props.toMonth)) {
...
process.env.NODE_ENV !== "production" ? RangeDatePicker.propTypes = {
  ...
  initialFromDate: instanceOf(Date),
  initialToDate: instanceOf(Date),
  toMonth: instanceOf(Date)
} : void 0;
...
process.env.NODE_ENV !== "production" ? SwitchComponent.propTypes = _extends({}, basePropTypes, {
  innerRef: instanceOf(typeof Element === 'undefined' ? function () {} : Element)
}) : void 0;

SwitchComponent.defaultProps = baseDefaultProps;

var Switch = forwardRef(function (props, ref) {
  return createElement(SwitchComponent, _extends({ innerRef: ref }, props));
});
...
var InAppMessageHeader = forwardRef(function (props, ref) {
  var className = props.className,
  ...
  return createElement(
    ...
    avatarProps && createElement(InAppMessageAvatar, avatarProps),
    text && createElement(
      'div',
      { className: styles$p[baseClass$D + '__heading'] },
      text
    ),
    createElement(InAppMessageCloseButton, { onClick: onCloseButtonClick })
  );
});

process.env.NODE_ENV !== "production" ? InAppMessageHeader.propTypes = {
  className: string,
  avatar: shape(_extends({}, InAppMessageAvatar.propTypes)),
  text: node,
...
var InAppMessageFooter = function InAppMessageFooter(props) {
  ...
  return createElement(
    'div',
    { className: mergedClassNames },
    createElement(RemindButton, null),
    createElement(
      Button,
...
process.env.NODE_ENV !== "production" ? InAppMessageFooter.propTypes = {
  className: string,
  buttons: shape({
    cta: shape(_extends({}, Button.propTypes.isRequired)).isRequired,
    remind: shape(_extends({}, Button.propTypes))
  })
} : void 0;
...
var InAppMessageBase = function (_React$PureComponent) {
  ...
  function InAppMessageBase() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args))), _this), _this.onOverlayClick = function (event) {
      ...
      _this.props.onClose();
    }, _this.inAppMessageContentRef = createRef(), _temp), possibleConstructorReturn(_this, _ret);
  }
    ...
    return createElement(
      ...
      createElement(
        ...
        createElement(
          ...
          createElement(InAppMessageHeader, {
          ...
          createElement(
            ...
            footerButtons && createElement(InAppMessageFooter, { buttons: footerButtons })
          )
        )
      )
    );
...
var InAppMessagePortal = function (_React$Component) {
  ...
  InAppMessagePortal.prototype.componentDidMount = function componentDidMount() {
    var element$$1 = document.querySelector(this.props.parentElementName);
    if (element$$1) element$$1.appendChild(this.inAppMessageContainer);
  };

  InAppMessagePortal.prototype.componentWillUnmount = function componentWillUnmount() {
    var element$$1 = document.querySelector(this.props.parentElementName);
    if (element$$1) element$$1.removeChild(this.inAppMessageContainer);
  };

  InAppMessagePortal.prototype.render = function render() {
    return createPortal(this.props.children, this.inAppMessageContainer);
  };
...
var InAppMessageImage = function InAppMessageImage(props) {
  ...
  return createElement(
    ...
    createElement('img', _extends({ alt: alt || 'InAppMessage Image' }, restProps))
  );
};
...
var InAppMessage = function InAppMessage(props) {
  ...
  return createElement(
    InAppMessageBase,
    _extends({ className: mergedClassNames }, restProps),
    imageProps && createElement(InAppMessageImage, imageProps),
    createElement(
      InAppMessageBody,
      null,
      children
...
process.env.NODE_ENV !== "production" ? InAppMessage.propTypes = _extends({}, InAppMessageBase.propTypes, {
  image: shape(_extends({}, InAppMessageImage.propTypes))
}) : void 0;
  ...
  function Dropdown() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args))), _this), _this.getModifiers = memoizeOne(Dropdown.buildPopperModifiers), _this.setPopupRef = function (ref) {
      ...
      return createElement(
        ...
        children,
        computedModifiers.arrow.enabled && createElement('div', {
          ref: arrowProps.ref,
...
process.env.NODE_ENV !== "production" ? Dropdown.propTypes = {
  ...
  className: string,
  closeOnEscPress: bool,
  closeOnEnterPress: bool,
  /**
   * you can specify which key press should trigger Dropdown close
   */
  closeKeyCodes: arrayOf(number),
  eventsEnabled: bool,
  isVisible: bool.isRequired,
  modifiers: object,
  placement: oneOf(['auto', 'auto-end', 'auto-start', 'bottom', 'bottom-end', 'bottom-start', 'left', 'left-end', 'left-start', 'right', 'right-end', 'right-start', 'top', 'top-end', 'top-start']),
  positionFixed: bool,
   ...
   */
  shouldUpdateOnResize: bool,
  triggerRenderer: func,
  zIndex: number,
  onClose: func
} : void 0;
...
var DropdownListItem = function (_React$PureComponent) {
  ...
  DropdownListItem.prototype.render = function render() {
    ...
    return createElement(
      ...
      isSelected && createElement(CheckIcon, {
        width: '15px',
        height: '15px',
...
process.env.NODE_ENV !== "production" ? DropdownList.propTypes = {
   ...
   */
  autoFocusedItemId: oneOfType([string, number]),
  autoFocusOnItemsCountChange: bool,
  className: string,
  /**
   * use this property to enable/disable keyboard events of DropdownList
   */
  keyboardEventsEnabled: bool,
  items: arrayOf(shape({
    className: string,
    itemId: oneOfType([string, number]).isRequired,
    content: node,
   ...
   */
  itemSelectKeyCodes: arrayOf(number)
} : void 0;
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args))), _this), _this.state = {
      ...
      return createElement(
        ...
        closeWithX && createElement(
          ...
          createElement(CloseIcon, { width: '16px', height: '16px' })
        ),
        children,
        computedModifiers.arrow.enabled && createElement('div', _extends({}, arrowProps, {
      ...
      var popperComponent = createElement(
        Popper,
        {
      ...
      return createElement(
        Manager,
        null,
        _this.props.trigger && createElement(
          Reference,
...
process.env.NODE_ENV !== "production" ? PopperTooltip.propTypes = {
   ...
   */
  withFadeAnimation: bool,
  style: object,
  /**
   * The theme changes the look of the tooltip.
   */
  theme: oneOf(['invert', 'important']),
  modifiers: object,
  onClose: func,
  placement: oneOf(['auto', 'auto-end', 'auto-start', 'bottom', 'bottom-end', 'bottom-start', 'left', 'left-end', 'left-start', 'right', 'right-end', 'right-start', 'top', 'top-end', 'top-start']),
  positionFixed: bool,
   ...
   */
  triggerActionType: oneOf(['managed', 'click', 'hover']),
...
process.env.NODE_ENV !== "production" ? CssTooltip.propTypes = {
  ...
  onClose: func,
  width: string,
  placement: oneOf(['bottom', 'bottom-end', 'bottom-start', 'left', 'left-end', 'left-start', 'right', 'right-end', 'right-start', 'top', 'top-end', 'top-start']),
  /**
...
var SpotlightOverlay = function SpotlightOverlay(_ref) {
  ...
  return createElement(
    ...
    disablePointerEvents && createElement('div', {
...
var VirtualReference = function () {
  function VirtualReference(element$$1, padding) {
...
var virtualReference = function virtualReference(element$$1, padding) {
  return new VirtualReference(element$$1, padding);
};
...
var UserGuideTooltip = function (_React$PureComponent) {
  ...
  UserGuideTooltip.prototype.render = function render() {
    ...
    var referenceElement = virtualReference(element$$1, spotlightPadding);
    var shouldSlide = !!(slide && this.state.shouldSlide);

    return createElement(
      ModalPortal,
      { parentElementName: containerName, zIndex: zIndex },
      createElement(SpotlightOverlay, {
        gap: rect,
        isVisible: isVisible,
        slide: shouldSlide,
...
process.env.NODE_ENV !== "production" ? UserGuideTooltip.propTypes = {
  ...
  className: string,
  zIndex: number.isRequired,
  element: oneOfType([node, instanceOf(typeof Element === 'undefined' ? function () {} : Element)]).isRequired,
  scrollableWrapper: instanceOf(typeof Element === 'undefined' ? function () {} : Element),
  isVisible: bool.isRequired,
  slide: bool,
  theme: oneOf(['invert', 'important']),
  placement: oneOf(['auto', 'auto-end', 'auto-start', 'bottom', 'bottom-end', 'bottom-start', 'left', 'left-end', 'left-start', 'right', 'right-end', 'right-start', 'top', 'top-end', 'top-start']),
  containerName: string,
  disableSpotlightPointerEvents: bool
} : void 0;
...
var Divider = function Divider(props) {
  ...
  return createElement('div', _extends({ className: mergedClassNames }, restProps));
};
...
var ProgressBar = forwardRef(function (_ref, ref) {
  var _cx;
...
var ProgressCircle = forwardRef(function (_ref, ref) {
  var _cx;
...
var Promo = function Promo(props) {
  ...
  return createElement(
    ...
    createElement(
      ...
      img && createElement('img', { src: img, className: styles$v[baseClass$S + '__img'] }),
      createElement(
        'div',
...
var FileUploadProgressActions = function FileUploadProgressActions(props) {
  ...
  return createElement(
    ...
    props.onRetryButtonClick && props.progressStatus === 'error' && createElement(
      'button',
      {
        type: 'button',
      ...
      createElement(RefreshIcon, null)
    ),
    props.onCloseButtonClick && props.progressStatus !== PROGRESS_STATUS.success && createElement(
      'button',
      {
        type: 'button',
...
process.env.NODE_ENV !== "production" ? FileUploadProgressActions.propTypes = {
   ...
   */
  onRetryButtonClick: func,
  progressStatus: oneOf(PROGRESS_STATUSES),
  isVisible: bool,
  className: string
} : void 0;

var FileUploadProgress = forwardRef(function (props, ref) {
  var _cx;
  ...
  return createElement(
    'div',
    _extends({}, restProps, { className: mergedClassNames, ref: ref }),
    icon && progressStatus !== PROGRESS_STATUS.success && createElement(
      'div',
      { className: styles$w[baseClass$U + '__icon'] },
      icon
    ),
    progressStatus === PROGRESS_STATUS.success && createElement(
      'div',
    ...
    createElement(
      ...
      createElement(
        ...
        createElement(FileUploadProgressActions, {
      ...
      progressStatus !== PROGRESS_STATUS.success && createElement(ProgressBar, {
        size: size,
...
process.env.NODE_ENV !== "production" ? FileUploadProgress.propTypes = {
   ...
   */
  actionsVisibilityState: oneOf(UPLOAD_PROGRESS_ACTIONS_STATES),
  className: string,
  /**
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$PureComponent.call.apply(_React$PureComponent, [this].concat(args))), _this), _this.state = {
      ...
      if (status === PROGRESS_STATUS.error) {
        return createElement(
          ...
          createElement(AlertCircleIcon, { fill: '#f4574c' })
        );
      }
      ...
      if (!(withError && (onRetryButtonClick || onCloseButtonClick))) {
        if (mode !== UPLOAD_BAR_MODE.single) {
          return createElement(
            ...
            createElement(CollapseIcon, { isExpanded: _this.getIsExpanded() })
          );
        }
      ...
      return createElement(
        ...
        onRetryButtonClick && createElement(
          'button',
          {
            type: 'button',
        ...
        onCloseButtonClick && createElement(
          'button',
          {
            type: 'button',
      ...
      return createElement(
        ...
        createElement(
          ...
          createElement(
            ...
            createElement(FileUploadProgress, {
      ...
      return createElement(
        ...
        createElement(
          TransitionGroup,
          { component: null },
          _this.getIsExpanded() && createElement(
            CSSTransition,
            {
              timeout: 300,
              classNames: {
...
var UploadBar = forwardRef(function (props, ref) {
  return createElement(UploadBarComponent, _extends({ innerRef: ref }, props));
});
...
var SearchBar$1 = forwardRef(function SearchBarWithRef(props, ref) {
  return createElement(SearchBar, _extends({}, props, { forwardedRef: ref }));
});
...
var Icon = function Icon(props) {
  ...
  var GeneratedIcon = createElement(source, _extends({}, IconSize[size], {
    fill: filledColor
  }));
...
process.env.NODE_ENV !== "production" ? Icon.propTypes = {
   ...
   */
  disabled: bool,
  iconType: oneOf(['primary', 'inverted', 'link', 'success', 'warning', 'error']),
  className: string
} : void 0;
...
export { helpers, Button, ButtonGroup, Banner, Card, Tab, TabsWrapper, TabsList, Tooltip, TooltipContent, Toast, ToastWrapper, NotificationProvider, ToastConsumer, NotificationContext, notificationConnect, ModalBase, ModalPortal, ActionModal, ActionModalActions, ActionModalContent, ActionModalHeading, ActionModalIcon, Modal, ModalFooter, ModalHeader, ModalBody, TextField, Input, InputField, TextArea, TextAreaField, RadioButton, CheckboxField, Form, FormGroup, FieldGroup, FieldError, FieldLabel, FieldDescription, Select, SelectField, MultiSelect, MultiSelectField, NumericInput, NumericInputField, DatePicker$1 as DatePicker, RangeDatePicker, DatePickerRangeSelectInputs, DatePickerRangeCalendarsWrapper, Switch, InAppMessageBase, InAppMessagePortal, InAppMessage, InAppMessageFooter, InAppMessageHeader, InAppMessageBody, Badge, Dropdown, DropdownList, DropdownListItem, PopperTooltip, CssTooltip, UserGuideTooltip, Loader, Divider, ProgressBar, ProgressCircle, Promo, UploadBar, FileUploadProgress, SearchBar$1 as SearchBar, Icon, IconSizeName as IconSize, IconTypeName as IconType };
